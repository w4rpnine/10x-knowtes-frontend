...
export default function SummaryPreviewModal({
  ...
  const handleAccept = async () => {
    ...
    try {
      const response = await fetch(`${getApiBaseUrl()}/api/topics/${topicId}/summaries/${summary_stat_id}/accept`, {
        method: "PUT",
        headers: {
  ...
  const handleReject = async () => {
    setIsProcessing(true)
    try {
      const response = await fetch(`${getApiBaseUrl()}/api/topics/${topicId}/summaries/${summary_stat_id}/reject`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "X-Requested-With": "XMLHttpRequest"
